...
<html>
    ...
    <body>
        ...
        // foreach ($masyvas as $stalcius) { //stalcius - issigalvotas masyvas
        //   echo $stalcius . "<br>";
        // } //sutikus "}" foreach ciklas pakeis "$stalcius" reiksme i sekancio masyvo elementa
        ...
        print_r($masina);
        // var_dump($masyvas);
        foreach ($masina as $stalcius) { // $stacius - stalciaus turinys
          echo $stalcius . "<br>";
          $sk = 0;
          echo "$sk $stalcius <br>";
          $sk++;
