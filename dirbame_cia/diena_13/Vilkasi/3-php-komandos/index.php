...
<html>
    ...
    <body>
        ...
        <?php
          ...
          // foreach ($masyvas as $stalcius) {  //isgalvotas kintamasis
          //     echo $stalcius ."<br>";
          // } //sutikus "{" foreach ciklas pakeis "$stalcius" reiksme i sekancio masyvo elemento

          $masina = ["spalva" => "raudona", "maxGreitis" => 220, "kuras" => "benzinas"];
          ...
          $tekstas = "Vienas du trys ketiuri. miskas lape koja bala." ;
          echo $tekstas . "<br>";
          $x = str_replace("Vienas", "Simtas", $tekstas);
          echo $x . "<br>";
