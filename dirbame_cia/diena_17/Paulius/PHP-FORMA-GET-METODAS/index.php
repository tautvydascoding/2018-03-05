...
<?php
      ...
      ?>
          <h2> Registracija </h2>
          <form class="" action="registration.php" method="GET"> <!--jei POST uzkoduoti duomenys// jeigu get tai nekoduos duomenu-->
          ...
          <!--  <input type="submit" name="tel" value="Registration" placeholder="Phone"> -->
            <!--arba-->
            <button type="submit" name="">Registration</button>
          </form>

          <?php

              print_r( $_GET ); // jeigu method= "GET" atsispaudinam duomenis suvestus i FORMA
