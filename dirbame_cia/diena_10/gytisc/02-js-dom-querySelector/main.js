...
for (var i = 0; i < 3; i++) {
  visiStraipsniai[i].innerHTML = "Pakeista su FOR ciklu"; //keiciam tekstus
  visiStraipsniai[i].style.color = "blue"; // keiciam dizaina/visiem pakeistiem tekstam uzdedam spalva keiciant css
  visiStraipsniai[i].style.backgroundColor = "#f1f1f1"; //keiciame teksto lauko fona
}

//===================keičiame h2 ir new Promise(function(resolve, reject) {
