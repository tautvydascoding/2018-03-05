    ...
    <body>
        ...
        // uzduotis5: patobulinti uzduotis4,
          ...
          <ul>
              ...
              <li>
               <?php
                $manoGydytojas = getDoctor(1); // gryzta masyvas (array)
            ...
            <li>
             <?php
              $manoGydytojas = getDoctor(2); // gryzta masyvas (array)
              echo $manoGydytojas['name'] . " " .$manoGydytojas['lname'];
              ?>
            </li>
            ...
            <li>
               <?php
                $manoGydytojas = getDoctor(3); // gryzta masyvas (array)
                echo $manoGydytojas['name'] . " " .$manoGydytojas['lname'];
                ?>
            </li>
...
<!-- ============ARBA SU FOR CIKLU======================= -->
<h3> uzduotis 3 su for Ciklu</h3>
<ul>
  <?php
    for ($i=1; $i < 5 ; $i++) : // ":" - vietoj skliausteliu "{}"
