...
<html>
    ...
    <body>
        ...
        <?php
        require_once('./doctors-functions.php');
         ?>


<!-- Uzduotis 3 -->
<h2> Gydytoju isvedimas </h2>
<ul>
  <li>
<?php
$manoGydytojas = getDoctor(4); // grizta masyvas(array)
echo $manoGydytojas['name'] . " " . $manoGydytojas['lname'];
 ?>
  </li>
<li>
  <?php
    $manoGydytojas = getDoctor(2); //grizta masyvas(array)
    echo $manoGydytojas['name'] . " " . $manoGydytojas['lname'];
    ?>
    </li>
    <li>
      <?php
      $manoGydytojas = getDoctor(3); //grizta masyvas(array)
    echo $manoGydytojas['name'] . " " . $manoGydytojas['lname'];
?>
    </li>
    </ul>
