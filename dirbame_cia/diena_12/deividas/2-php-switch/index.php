...
<html>
    ...
    <body>
     ...
     // "opel" - atspausdinti "Susimastykite apie naujus priedus" -->
         $vardas = 'audi';
         $vardas = trim ($vardas); //pasaliname "", tab, ... ir kitus tokius spec. simbolius
         $vardas = strtolower ($vardas); // pavercia mazosiomis raidemis

         switch (strtolower (trim($vardas)) ) {
          // switch ($vardas) {
           case 'audi':
                    echo "111Susimastykite apie variklio prieziura";
             break;

           case 'audi':
                    echo "sitas niekada nesuveiks";
             break;
           ...
           default:
                    echo "Tokiai: $vardas marekei patarimu neturime";
             break;
         }
